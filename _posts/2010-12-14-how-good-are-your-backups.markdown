...
<ul>
  ...
  <li style="margin:20px;"><strong><a href="http://github.com/">Github</a>.</strong> Every piece of source code written since we founded our business is now stored in Github. The IP in our source code is our most important asset and I do not consider source code to really exist until it is pushed to Github and then pulled in at least one other location (usually my laptop). The pushing/pulling of source code is the only manual process in my backup strategy but source code is so key to what I do every day it has become pure habit to always push at the end of the day.</li>
</ul>
