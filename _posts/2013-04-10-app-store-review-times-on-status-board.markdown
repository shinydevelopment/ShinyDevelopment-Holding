...
![App Store Review Times on Status Board](http://shinydev.s3.amazonaws.com/blog-files/app-store-review-times-on-status-board.png)

You can add either a simple table with the current review times for both the iOS and Mac App Stores, or if you want a bit more detail then you can add the 30 day trend as a graph.

<p class="fancy-link"><a href="panicboard://?url=http%3A%2F%2Freviewtimes.shinydevelopment.com%2Fsb_table.html&amp;panel=table&amp;sourceDisplayName=Shiny%20Development">Install &ldquo;Current Review Times&rdquo; Table</a></p>
<p class="fancy-link"><a href="panicboard://?url=http%3A%2F%2Freviewtimes.shinydevelopment.com%2Fsb_trend30.json&amp;panel=graph&amp;sourceDisplayName=Shiny%20Development">Install &ldquo;30 Day Trend&rdquo; Graph</a></p>
